...
class Menu_Image_Plugin {
	...
	public function menu_image_add_inline_style_action() {
		wp_register_style( 'menu-image', plugins_url( '', __FILE__ ) . '/js/menu-image.css', array(), '1.1', 'all' );
	...
	public function menu_image_admin_head_nav_menus_action() {
		wp_enqueue_script( 'menu-image-admin', plugins_url( 'js/menu-image-admin.js', __FILE__ ), array( 'jquery' ) );
		wp_localize_script(
