...
<div id="content-vw">
	<div class="container">
		...
		<h1>Please Select from the Menu To navigate to the Desired Pages</h1>
		...
		<p class="text-404"><?php esc_html_e( 'Dont worry&hellip it happens to the best of us.', 'vw-travel' ); ?></p>
		 <div class="more-btn">
	        <a href="<?php echo home_url(); ?>"><i class="fas fa-plus"></i><?php esc_html_e( 'Home page', 'vw-travel' ); ?><i class="fas fa-angle-right"></i></a>
	    </div> 
